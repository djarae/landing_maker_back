...
namespace LandingMakerBack.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Landings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LandingId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LandingSections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LandingSections_Landings_LandingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Landings_IsPublished",
                table: "Landings",
                column: "IsPublished");

            migrationBuilder.CreateIndex(
                name: "IX_Landings_UserId",
                table: "Landings",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_LandingSections_LandingId_Order",
                table: "LandingSections",
                columns: new[] { "LandingId", "Order" });
